<script lang="ts">
	import IceCream from '$lib/icon/IceCream.svelte';
...
>
	<div class="mx-6 mb-6 mt-12">
		...
		<div
			class="pattern mt-6 hidden border-y border-dotted border-y-outlineVariant px-3 py-2 text-xs text-onSurfaceVariant md:block"
		>
			<p>来自伯明翰的问候</p>
		</div>
		<Posts>
